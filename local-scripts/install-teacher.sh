#!/usr/bin/env bash
# Installs Go, gh, and the gh-teacher extension for teachers.
# Works on macOS, Linux, and Windows (Git Bash / MSYS2).
#
# Usage:
#   bash install-teacher.sh
#
...
info()    { echo "[install-teacher] $*"; }
success() { echo "[install-teacher] ✓ $*"; }
die()     { echo "[install-teacher] ✗ $*" >&2; exit 1; }
...
###############################################################################
# Build and install gh-teacher
###############################################################################

TEACHER_DIR="$REPO_DIR/cli/gh-teacher"
cd "$TEACHER_DIR"

info "Running: go mod tidy"
go mod tidy

info "Running: go build -o gh-teacher ."
go build -o gh-teacher .

info "Running: gh extension install . --force"
gh extension remove teacher 2>/dev/null || true
gh extension install .

success "gh-teacher installed."
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  gh-teacher is ready!"
echo ""
echo "  Next: log in with GitHub:"
echo "    gh teacher login"
echo ""
echo "  Then initialize your org:"
echo "    gh teacher init <org>"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
